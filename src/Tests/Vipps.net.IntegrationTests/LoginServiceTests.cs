...
public class LoginServiceTests
{
    ...
    public async Task Init_Ciba_With_Redirect_Test()
    {
        ...
        {
            Scope = "openid email", PhoneNumber = CustomerPhoneNumber, BindingMessage = "testing"
        };
        InitCibaResponse response = await vippsApi.LoginService().InitCiba(initCibaRequest, AuthenticationMethod.Basic); 
